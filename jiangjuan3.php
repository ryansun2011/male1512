...
$sql = "select coupon_id,coupon_url from ".DB_PREFIX."coupons2 where is_use=0 limit 1";
...
if($numRows==0){
	...
	$sql = "update ".DB_PREFIX."coupons2 set is_use=1,hmsr='$hmsr' where coupon_id=$coupon_id";
	$result = mysql_query($sql);
	if($result){
		//echo $coupon_url;
